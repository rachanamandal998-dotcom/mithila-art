  ...
  const mainPrograms = [
    {
      ...
      description:
        "Recurring workshops that encourage children from diverse backgrounds to learn Mithila painting and discuss SDG topics in age-appropriate ways. Programs culminate in recognition and awards celebrating young artists' achievements.",
    ...
    },
    {
      ...
      description:
        "Curriculum-aligned programs bringing Mithila art into classrooms, connecting art to history, geography, environmental science, and sustainability education through hands-on creative activities.",
    ...
    },
    {
      ...
      description:
        "Through support such as Arts Grants for Queens, we organize community shows that celebrate cultural festivals while raising awareness of SDGs among local residents. These exhibitions connect heritage with contemporary issues.",
    ...
    },
    {
      ...
      description:
        "Sessions with professors, cultural historians, and master artists exploring Mithila art, literature, and linguistics, and the need for heritage preservation. These programs deepen understanding of cultural significance.",
    ...
    },
    {
      ...
      description:
        "Connecting master artists from Mithila with emerging artists in the diaspora to preserve traditional knowledge and techniques through structured mentorship relationships.",
    ...
    },
    {
      ...
      description:
        "Team-building workshops and cultural experiences for organizations seeking unique, meaningful employee engagement activities that connect creativity with cultural awareness.",
  ...
  const communityInitiatives = [
    {
      ...
      description:
        "Fair trade marketplace connecting rural artists directly with global buyers, ensuring sustainable livelihoods and economic empowerment for traditional Mithila artists.",
    },
    {
      icon: Globe,
      title: "Cultural Archive Initiative",
      description:
        "Digital preservation of traditional designs, techniques, and oral histories from master artists, creating a comprehensive repository for future generations.",
    },
    {
      icon: Award,
      title: "Youth Ambassador Program",
      description:
        "Training young Maithils to become cultural ambassadors in their schools and communities, empowering the next generation of heritage advocates.",
    },
    {
      icon: Heart,
      title: "Artist Relief Fund",
      description:
        "Emergency support for traditional artists facing financial hardship, natural disasters, or other crises affecting their ability to practice their craft.",
    },
    {
      icon: Lightbulb,
      title: "Youth Leadership Fellowships",
      description:
        "Structured programs around cultural organizing and SDG advocacy through art, developing future leaders in heritage preservation.",
    },
    {
      icon: MessageCircle,
      title: "Community Dialogue Series",
      description:
        "Regular forums for diaspora members, scholars, and community leaders to discuss Mithila culture preservation in contemporary contexts.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground text-left md:text-justify  hyphens-auto leading-relaxed">
              Beyond headline festivals and exhibitions, Mithila Center USA runs
              comprehensive educational workshops, community initiatives, and
              programs that make us not just an exhibition organizer, but a
            ...
            <div className="aspect-video bg-muted rounded-2xl overflow-hidden relative">
              ...
              <div className="absolute inset-0 bg-gradient-overlay flex items-end p-8">
                <p className="text-white font-playfair text-2xl font-semibold">
                  Inspiring the next generation of Mithila artists through
                  hands-on learning
                </p>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-left md:text-justify  hyphens-auto">
          ...
          <p className="text-lg text-muted-foreground text-center max-w-3xl mx-auto mb-16">
            Our programs are designed to make Mithila art accessible to all ages
            while connecting traditional heritage with contemporary social
            issues and SDG themes.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {mainPrograms.map((program, index) => (
              <div
                key={index}
                className="glass-card rounded-2xl p-8 group hover:shadow-elevated transition-all duration-300"
              >
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Beyond workshops, we're building sustainable systems to support
                artists, preserve heritage, and empower the next generation of
                cultural leaders.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-peacock text-secondary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
            Whether you're looking to learn Mithila painting, bring a program to
            your school, engage your organization, or support artist
