...
const programs = [
  {
    ...
    title: "Art Classes",
    description:
      "Weekly painting sessions teaching traditional Mithila techniques with natural colors.",
  ...
  },
  {
    ...
    title: "Story Time",
    description:
      "Explore ancient Maithili tales and legends that inspire our unique art forms.",
    color: "bg-haldi",
  },
  {
    icon: Users,
    title: "Family Days",
    description:
      "Special weekend programs for the whole family to create art together.",
    color: "bg-peacock",
  },
  {
    icon: Star,
    title: "Summer Camp",
    description:
      "Immersive week-long programs exploring all aspects of Mithila culture.",
    color: "bg-leaf",
  },
];
...
export const KidsSection = () => {
  ...
  return (
    <section
      id="programs"
      ref={sectionRef}
      className="relative py-24 lg:py-32 bg-gradient-to-br from-maithilpink/10 via-background to-haldi/10 overflow-hidden mt-[-5] lg:mt-0"
    >
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative">
              ...
              <div
                className="absolute -bottom-6 -left-6 px-6 py-4 rounded-2xl bg-peacock shadow-elevated animate-float"
                style={{ animationDelay: "1s" }}
              >
                <div className="flex items-center gap-3">
                  <span className="text-3xl">🌟</span>
                  <div>
                    <p className="font-playfair font-bold text-secondary-foreground">
                      100+ Kids
                    </p>
          ...
          >
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our youth programs introduce children to the magical world of
                Mithila art through fun, engaging activities that develop
                creativity while preserving cultural heritage.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 ">
              {programs.map((program, index) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl ${program.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
